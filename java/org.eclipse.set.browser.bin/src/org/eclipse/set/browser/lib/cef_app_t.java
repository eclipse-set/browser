...
public class cef_app_t {
	...
	/// function is called by the browser and render processes on multiple
	/// threads.
	///
	/** @field cast=(void*) */
	...
	/// before
	/// processing by CEF and Chromium. The |process_type| value will be NULL
	/// for
	/// the browser process. Do not keep a reference to the cef_command_line_t
	/// object passed to this function. The
	/// CefSettings.command_line_args_disabled
	/// value can be used to start with an NULL command-line object. Any values
	/// specified in CefSettings that equate to command-line arguments will be
	/// set
	...
	/// reference
	/// to the |registrar| object. This function is called on the main thread
	/// for
