...
public class cef_load_handler_t {
	...
	/// never be NULL -- call the is_main() function to check if this frame is
	/// the
	/// main frame. Multiple frames may be loading at the same time. Sub-frames
	/// may
	/// start or continue loading after the main frame load has ended. This
	/// function will not be called for same page navigations (fragments,
	/// history
	...
	///
	/// Called when a navigation fails or is canceled. This function may be
	/// called
	/// by itself if before commit or in combination with OnLoadStart/OnLoadEnd
	/// if
	...
	/// |transition_type| provides information about the source of the
	/// navigation
	...
	/// cancellation
	/// of failure. It will be called before any calls to OnLoadStart and after
	/// all
