 ...
 * </pre>
 *
 * The following notifications are emitted when the user selects a hyperlink
 * that targets a new window or as the result of a javascript that executes
 * window.open.
 *
 * <p>
 * Main Browser
...
public class WindowEvent extends TypedEvent {
	...
	/**
	 * Specifies whether the <code>Shell</code> hosting the <code>Browser</code>
	 * should display a menu bar. Note that this is always <code>true</code> on
	 * OS X.
	 *
	 * @since 3.1
	 */
	 ...
	 * <code>Shell</code> hosting the <code>Browser</code> should be large
	 * enough to accommodate that size. It is <code>null</code> if no size has
	 * been requested.
	 */
	public Point size;
	...
	public String toString() {
		...
		return string.substring(0, string.length() - 1) // remove trailing '}'
				+ " required=" + required + " browser=" + browser + " location="
				+ location + " size=" + size + " addressBar=" + addressBar
